...
def generate_tests_cmd(
    ...
    output: str = typer.Option("generated_tests", "--output", "-o", help="Output directory for generated tests"),
) -> None:
    ...
    counts = {"circuit_breaker_positive": 0, "circuit_breaker_negative": 0,
              "risk_signal": 0, "uncertainty_type": 0}
    ...
    output_file.write_text(yaml.dump(suite, default_flow_style=False, sort_keys=False), encoding="utf-8")
